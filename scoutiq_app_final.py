...
with st.sidebar:
    ...
    st.markdown("""<div style='text-align:center;padding:0.5rem 0 1rem 0;'>
        <div style='color:#8B9DC3;font-size:0.75rem;letter-spacing:2px;text-transform:uppercase;'>Find The Next MO & KDB Before Market Do</div>
    </div>""", unsafe_allow_html=True)
    st.divider()
    page = option_menu(
        menu_title=None,
        options=["Home", "Benchmarks", "Scout Engine", "Player Profile", "Market Intelligence", "About"],
        icons=["house", "bar-chart-line", "binoculars", "person-badge", "graph-up-arrow", "info-circle"],
        default_index=0,
        styles={
