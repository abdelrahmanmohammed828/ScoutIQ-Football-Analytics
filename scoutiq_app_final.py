...
# ════════════════ ABOUT ════════════════
    ...
    with col2:
        ...
        <div class='player-card' style='margin-top:1rem;'>
            ...
            <div style='color:#8B9DC3;font-size:0.85rem;line-height:2;'>👤 Abdelrahman M. Elhosary<br>🎓 USM · ABW508 Analytics Lab<br>👨‍🏫 Dr. Muhammad Shabir Bin Shaharudin<br>📊 264 players · 3 leagues · 34 valued<br>🤖 PCA 80.0% · K-Means K=4 · Hybrid Sim<br>💶 Max saving: €14.2M (Salah targets) and €17.2M (KDB targets) per signing<br>🏆 7 CRISP-DM phases · 4 gaps solved</div>
        </div>""", unsafe_allow_html=True)
    st.divider()
